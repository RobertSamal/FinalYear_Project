...
{
	$login->redirect('../admin/admin.php'); // Redirect to admin page if user is already logged in
}

if(isset($_POST['btn-login']))
{
  //get this data from the form
	...
	{
		$login->redirect('../admin/admin.php'); // Redirect to admin page if login is successful
	}
	else
	{
		$error = "<b><font color='red'>Wrong Details !</font></b>"; // Set error message if login fails
	}
}
?>
